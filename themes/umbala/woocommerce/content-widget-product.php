...
<li>
	<a class="alus-widget-image" href="<?php echo esc_url( get_permalink( $product->get_id() ) ); ?>" title="<?php echo esc_attr( $product->get_title() ); ?>">
	...
	<div class="alus-meta-widget">
		<?php umbala_template_product_categories(); ?>
