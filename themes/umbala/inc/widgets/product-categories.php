<?php
add_action('widgets_init', 'umbala_product_categories_load_widgets');

function umbala_product_categories_load_widgets()
{
	register_widget('Umbala_Product_Categories_Widget');
}

if(!class_exists('Umbala_Product_Categories_Widget')){
	class Umbala_Product_Categories_Widget extends WP_Widget {

		function __construct() {
			$widget_ops = array('classname' => 'alus-product-categories-widget', 'description' => esc_html__('Display Product Categories', 'umbala'));
			parent::__construct('alus_product_categories', esc_html__('Umbala - Product Categories', 'umbala'), $widget_ops);
		}
		...
		function form( $instance ) { 
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_post_count')); ?>"><?php esc_html_e('Show post count', 'umbala'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_sub_cat')); ?>"><?php esc_html_e('Show sub categories', 'umbala'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('hide_empty')); ?>"><?php esc_html_e('Hide empty categories', 'umbala'); ?></label>
			</p>
			<p>
				...
				<span class="description"><?php esc_html_e("Don't select to show all", "umbala"); ?></span>
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('orderby')); ?>"><?php esc_html_e('Order by', 'umbala'); ?></label>
				<select class="widefat" id="<?php echo esc_attr($this->get_field_id('orderby')); ?>" name="<?php echo esc_attr($this->get_field_name('orderby')); ?>" >
					<option value="name" <?php selected($instance['orderby'], 'name'); ?> ><?php esc_html_e('Name', 'umbala'); ?></option>
					<option value="slug" <?php selected($instance['orderby'], 'slug'); ?> ><?php esc_html_e('Slug', 'umbala'); ?></option>
					<option value="count" <?php selected($instance['orderby'], 'count'); ?> ><?php esc_html_e('Number product', 'umbala'); ?></option>
					<option value="rand" <?php selected($instance['orderby'], 'rand'); ?> ><?php esc_html_e('Random', 'umbala'); ?></option>
					<option value="none" <?php selected($instance['orderby'], 'none'); ?> ><?php esc_html_e('None', 'umbala'); ?></option>
				</select>
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('order')); ?>"><?php esc_html_e('Order', 'umbala'); ?></label>
				<select class="widefat" id="<?php echo esc_attr($this->get_field_id('order')); ?>" name="<?php echo esc_attr($this->get_field_name('order')); ?>" >
					<option value="asc" <?php selected($instance['order'], 'asc'); ?> ><?php esc_html_e('Ascending', 'umbala'); ?></option>
					<option value="desc" <?php selected($instance['order'], 'desc'); ?> ><?php esc_html_e('Descending', 'umbala'); ?></option>
				</select>
			</p>
