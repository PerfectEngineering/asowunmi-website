<?php
add_action('widgets_init', 'umbala_products_load_widgets');

function umbala_products_load_widgets()
{
	register_widget('Umbala_Products_Widget');
}

if( !class_exists('Umbala_Products_Widget') ){
	class Umbala_Products_Widget extends WP_Widget {

		function __construct() {
			$widget_ops = array('classname' => 'alus-items-widget', 'description' => esc_html__('Display products on your sidebar','umbala'));
			parent::__construct('alus_products', esc_html__('Umbala - Products','umbala'), $widget_ops);
		}
		...
		function widget( $args, $instance ) {
			...
			if( $products->have_posts() ){
				...
				<div class="alus-product-items-widget <?php echo esc_attr($extra_class); ?>" data-nav="<?php echo esc_attr($show_nav) ?>" data-auto_play="<?php echo esc_attr($auto_play) ?>">
			...
			function form( $instance ) {
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('product_type')); ?>"><?php esc_html_e('Product type', 'umbala'); ?> </label>
					<select class="widefat" id="<?php echo esc_attr($this->get_field_id('product_type')); ?>" name="<?php echo esc_attr($this->get_field_name('product_type')); ?>">
						<option value="recent" <?php selected($instance['product_type'], 'recent'); ?>><?php esc_html_e('Recent', 'umbala'); ?></option>
						<option value="sale" <?php selected($instance['product_type'], 'sale'); ?>><?php esc_html_e('Sale', 'umbala'); ?></option>
						<option value="featured" <?php selected($instance['product_type'], 'featured'); ?>><?php esc_html_e('Featured', 'umbala'); ?></option>
						<option value="best_selling" <?php selected($instance['product_type'], 'best_selling'); ?>><?php esc_html_e('Best selling', 'umbala'); ?></option>
						<option value="top_rated" <?php selected($instance['product_type'], 'top_rated'); ?>><?php esc_html_e('Top rated', 'umbala'); ?></option>
						<option value="mixed_order" <?php selected($instance['product_type'], 'mixed_order'); ?>><?php esc_html_e('Mixed order', 'umbala'); ?></option>
					</select>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_thumbnail')); ?>"><?php esc_html_e('Show thumbnail', 'umbala'); ?></label>
				</p>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('thumbnail_size')); ?>"><?php esc_html_e('Thumbnail size', 'umbala'); ?> </label>
					<select class="widefat" id="<?php echo esc_attr($this->get_field_id('thumbnail_size')); ?>" name="<?php echo esc_attr($this->get_field_name('thumbnail_size')); ?>">
						<option value="shop_thumbnail" <?php selected($instance['thumbnail_size'], 'shop_thumbnail'); ?>><?php esc_html_e('Thumbnail Image', 'umbala'); ?></option>
						<option value="shop_catalog" <?php selected($instance['thumbnail_size'], 'shop_catalog'); ?>><?php esc_html_e('Catalog Image', 'umbala'); ?></option>
						<option value="shop_single" <?php selected($instance['thumbnail_size'], 'shop_single'); ?>><?php esc_html_e('Single Image', 'umbala'); ?></option>
					</select>
				</p>

				<p>
					<input type="checkbox" id="<?php echo esc_attr($this->get_field_id('show_categories')); ?>" name="<?php echo esc_attr($this->get_field_name('show_categories')); ?>" value="1" <?php echo ($instance['show_categories'])?'checked':''; ?> />
					<label for="<?php echo esc_attr($this->get_field_id('show_categories')); ?>"><?php esc_html_e('Show categories', 'umbala'); ?></label>
				</p>

				<p>
					<input type="checkbox" id="<?php echo esc_attr($this->get_field_id('show_product_title')); ?>" name="<?php echo esc_attr($this->get_field_name('show_product_title')); ?>" value="1" <?php echo ($instance['show_product_title'])?'checked':''; ?> />
					<label for="<?php echo esc_attr($this->get_field_id('show_product_title')); ?>"><?php esc_html_e('Show product title', 'umbala'); ?></label>
				</p>

				<p>
					<input type="checkbox" id="<?php echo esc_attr($this->get_field_id('show_price')); ?>" name="<?php echo esc_attr($this->get_field_name('show_price')); ?>" value="1" <?php echo ($instance['show_price'])?'checked':''; ?> />
					<label for="<?php echo esc_attr($this->get_field_id('show_price')); ?>"><?php esc_html_e('Show price', 'umbala'); ?></label>
				</p>

				<p>
					<input type="checkbox" id="<?php echo esc_attr($this->get_field_id('show_rating')); ?>" name="<?php echo esc_attr($this->get_field_name('show_rating')); ?>" value="1" <?php echo ($instance['show_rating'])?'checked':''; ?> />
					<label for="<?php echo esc_attr($this->get_field_id('show_rating')); ?>"><?php esc_html_e('Show rating', 'umbala'); ?></label>
				</p>
